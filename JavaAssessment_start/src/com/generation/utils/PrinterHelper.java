...
public class PrinterHelper
{
    ...
    public static Student createStudentMenu( Scanner scanner ) throws ParseException
    {
        ...
        while (!validDate) {
            ...
            try {
                birthDate = formatter.parse(inputDate); //this converts the String date to Date object
                validDate = true;
            } catch (ParseException e) {
                System.out.println("Invalid date format. Make sure you type the date using the following format: MM/dd/yyyy");
