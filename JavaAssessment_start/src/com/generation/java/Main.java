...
public class Main
{
    ...
    private static void gradeStudent( StudentService studentService, Scanner scanner )
    {
        ...
        HashMap<String, EnrolledCourse> getEnrolledCourses = studentService.enrolledCourses(student);

        for (Course i : getEnrolledCourses.values()) {
            System.out.println(i);
        }

        System.out.println( "Enter Course ID to be graded: " );
        String courseId = scanner.next();
        Course course = studentService.findEnrolledCourse( student, courseId );
...
//5) studentService.gradeStudent(student, course, grade)
    ...
    //This method requests user input for Student ID and returns Student object
    ...
    //This method is called in getStudentInformation() to check if student exists
    ...
    private static void showPassedCourses(StudentService studentService, Scanner scanner )
    {
        ...
        //Get student id from scanner
        //call method from StudentService to return the passed courses

        Student student = getStudentInformation(studentService, scanner);
        HashMap<String, EnrolledCourse> c = student.findPassedCourses();
        for (EnrolledCourse i : c.values()) {
            System.out.println(i);
        }
    }
}
